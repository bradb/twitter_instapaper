...
instafavs only polls your latest 20 favorites each time, so you should ensure
your cron job is set at a reasonable enough interval that no favorites will
be missed.
